...
public class MuPDFPageView extends PageView implements MuPDFView {
	...
	public MuPDFPageView(Context c, FilePicker.FilePickerSupport filePickerSupport, MuPDFCore core, Point parentSize, Bitmap sharedHqBm, int mode) {
		super(c, parentSize, sharedHqBm, mode);
