...
import com.cgd.ebook.boighor.lib.Xiaolong;
...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport
{
	...
	private String xiaolong = "ww2Z7hmA1LE=cGlzNjE4";
	...
	public void createUI(Bundle savedInstanceState) {
		...
		mDocView.setAdapter(new MuPDFPageAdapter(this, this, core, viewMode));
	...
	protected void setViewMode(int mode) {
		...
		mDocView.setAdapter(mReflow ? new MuPDFReflowAdapter(this, core, viewMode) : new MuPDFPageAdapter(this, this, core, viewMode));
					...
					if (which == AlertDialog.BUTTON_POSITIVE){
						new android.os.AsyncTask<Void, Void, Void>() {
							...
							protected void onPreExecute() {
								mDialog = new ProgressDialog(MuPDFActivity.this);
								mDialog.setTitle("Save");
								mDialog.setMessage("Saving the data...");
							...
							protected void onPostExecute(Void result) {
								Toast.makeText(MuPDFActivity.this, "File is saved", Toast.LENGTH_LONG).show();
								finish();
							};
