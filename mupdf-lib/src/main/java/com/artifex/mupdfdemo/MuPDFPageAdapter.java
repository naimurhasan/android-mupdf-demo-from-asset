...
public class MuPDFPageAdapter extends BaseAdapter {
	...
	public MuPDFPageAdapter(Context c, FilePicker.FilePickerSupport filePickerSupport, MuPDFCore core, int mode) {
		mContext = c;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			pageView = new MuPDFPageView(mContext, mFilePickerSupport, mCore, new Point(parent.getWidth(), parent.getHeight()), mSharedHqBm, viewMode);
		} else {
			pageView = (MuPDFPageView) convertView;
		}
		//pageView.setViewMode(0);
